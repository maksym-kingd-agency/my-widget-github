...
var _normalizeTrailingSlash = __webpack_require__(36213);
...
const addLocale = (path, ...args)=>{
    if (true) {
        return (0, _normalizeTrailingSlash).normalizePathTrailingSlash((__webpack_require__(93431).addLocale)(path, ...args));
    }
    return path;
};
...
function getDomainLocale(path, locale, locales, domainLocales) {
    if (true) {
        const normalizeLocalePath = (__webpack_require__(66455).normalizeLocalePath);
        const detectDomainLocale = (__webpack_require__(39958).detectDomainLocale);
...
var _addLocale = __webpack_require__(24077);
var _routerContext = __webpack_require__(24964);
var _appRouterContext = __webpack_require__(3280);
var _useIntersection = __webpack_require__(19190);
var _getDomainLocale = __webpack_require__(67361);
var _addBasePath = __webpack_require__(65299);
...
const normalizeLocalePath = (pathname, locales)=>{
    if (true) {
        return (__webpack_require__(34014).normalizeLocalePath)(pathname, locales);
    }
    return {
        pathname,
...
var _requestIdleCallback = __webpack_require__(82120);
...
module.exports = __webpack_require__(99938)
