...
var ssr_window_esm = __webpack_require__(61351);
// EXTERNAL MODULE: ../../node_modules/swiper/shared/utils.mjs
var utils = __webpack_require__(53392);
...
/* harmony import */ var _ssr_window_esm_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(61351);
...
function calcSupport() {
    const window1 = (0,ssr_window_esm.a)();
    const document1 = (0,ssr_window_esm.g)();
    return {
...
function loopCreate(slideRealIndex) {
    ...
    const addBlankSlides = (amountOfSlides)=>{
        for(let i = 0; i < amountOfSlides; i += 1){
            const slideEl = swiper.isElement ? (0,utils.c)("swiper-slide", [
...
function useIsomorphicLayoutEffect(callback, deps) {
    // eslint-disable-next-line
    if (true) return (0,external_react_.useEffect)(callback, deps);
